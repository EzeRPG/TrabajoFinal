...
<body>
	...
	<section id="seccion">
		<article class="articulo">
			<form action="DB/ModificarAD.php" method="post" enctype="multipart/form-data">
				<h1 class="instrucciones">Titulo de la publicacion que desea modificar</h1><br>

				<input type="text" name="titulo" autofocus class="ingresa" required>
				<br><br>
			
				<button type="submit" value="Submit" name="Submit" class="boton">MODIFICAR</button>
